...
# http/misconfiguration, and http/technologies directories into
# .nuclei-templates-cache/ (gitignored) — never committed to this repo. See
# docs/10-implementation-plan-ph1b.md Step 2's "Pinning, explicitly" note.
#
...
CATEGORIES=("http/exposed-panels" "http/misconfiguration" "http/technologies")
