...
type scanInput struct {
	...
	Detector         string                      `json:"detector" jsonschema:"one of idor, misconfig, authbypass, ssrf, businesslogic, netservice, sqli, mutatebfla, tls (netservice targets a \"tcp://host:port\" leaf, not an ordinary URL — see the scan tool's own targets field)"`
